...
INSERT INTO s06.data (id, country_id, state_code, period, value) VALUES (1, 1, N'AK', '20220331', 100);
INSERT INTO s06.data (id, country_id, state_code, period, value) VALUES (2, 2, N'AB', '20220331', 100);
...
INSERT INTO xls.handlers (TABLE_SCHEMA, TABLE_NAME, COLUMN_NAME, EVENT_NAME, HANDLER_SCHEMA, HANDLER_NAME, HANDLER_TYPE, HANDLER_CODE, TARGET_WORKSHEET, MENU_ORDER, EDIT_PARAMETERS) VALUES (N's06', N'usp_data', N'country_id', N'ParameterValues', N's06', N'countries', N'TABLE', N'[id],[country]', N'', NULL, NULL);
